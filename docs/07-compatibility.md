...
- Storage usage, quota, and persistence status depend on the browser StorageManager implementation;
  Settings displays an unavailable state when estimates are unsupported or restricted.
